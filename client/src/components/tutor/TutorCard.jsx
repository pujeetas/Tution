...
const TutorCard = ({ tutor }) => (
  <div className="flex flex-col gap-3 rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md">
    <div className="flex items-start justify-between gap-2">
      <div>
        <h3 className="text-lg font-semibold text-gray-900">{tutor.user?.name}</h3>
      ...
      <div className="text-right">
        <p className="text-lg font-bold text-primary-600">S${tutor.hourlyRate}</p>
    ...
    {tutor.bio && <p className="line-clamp-2 text-sm text-gray-600">{tutor.bio}</p>}
